...
export function buildSearchExtractionPrompt(userPrompt: string): string {
  ...
  return [
    ...
    "- Convert ranges like '10-40 acres' or 'between 10 and 40 acres' into minAcres / maxAcres.",
    "- Phrases like 'under 500k' mean maxPrice = 500000.",
    "- Phrases like 'at least 20 acres' mean minAcres = 20.",
